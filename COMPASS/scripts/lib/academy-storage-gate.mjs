...
export async function installAcademyStorageFixture(status) {
    ...
    const fixture=await createAcademyDatabase({materials:true,live:true,staff:true,runMaterials:true,revocations:true,rollout:true,obligations:true,cleanup:true,reviewSubmissions:true,administrationControls:true,runsPagination:true});
    try {
        ...
        for(const trigger of triggers) {
            ...
            installStage=`trigger_${trigger.tgname}`; await sql.query(trigger.definition);
        }
