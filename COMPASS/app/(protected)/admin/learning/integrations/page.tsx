...
import { getAcademyIntegrationConfig, listAcademyIntegrationIssuesPage, listAcademyM365Identities, listAcademyOrganizerCandidates, listAcademyOrganizers } from '@/lib/actions/academy-sessions'
...
export default async function AcademyIntegrationsPage({ searchParams }: { searchParams: { identity?: string } }) {
    ...
    const [config, organizers, candidates, issues, identities, health] = await Promise.all([getAcademyIntegrationConfig(), listAcademyOrganizers(), listAcademyOrganizerCandidates(), listAcademyIntegrationIssuesPage(), listAcademyM365Identities(search), getAcademyOperationsHealth()])
