...
export async function GET(request: Request) {
  ...
  const documents = [
    ...
    { slug: 'ai-notice', title: 'Informacja o narzędziach AI', visibility: 'authenticated', requires_acceptance: true,
      content_html: '<h1>Informacja o narzędziach AI</h1><h2>1. Zakres AI</h2><p>Platforma używa narzędzi AI do: dopasowania konsultantów do projektów (matching), przetwarzania CV przy onboardingu, oraz Compass Assist (asystent dla Centrali w panelu administracyjnym).</p><h2>2. Ograniczenia</h2><p>AI NIE podejmuje autonomicznych decyzji. Human-in-the-loop. Wszystkie sugestie wymagają potwierdzenia człowieka.</p><h2>3. Dane</h2><p>AI przetwarza tylko dane w ramach roli użytkownika. Nie trenuje modeli na danych osobowych.</p><h2>4. Wyłączenie</h2><p>Można zażądać wyłączenia funkcji AI w ustawieniach profilu lub przez kontakt z administracja@b2bnetwork.pl.</p>' },
