...
// Phase 34 — Opieka: active contractor roster + the conversation log (day-to-day care).
...
import {
    CONVERSATION_CATEGORY_PL, CONVERSATION_STATUS_PL, CONVERSATION_STATUS_BADGE, CONTRACTOR_STATUS_PL,
...
export function OpiekaPanel({ conversations, contractors, tcmProfiles, contractorsLite, onSaved }: Props) {
