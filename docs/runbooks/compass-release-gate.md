...
7. The tracked lock, local release tooling, and tokenless validation actions are pinned to engineering standard `2026.07.2` at `b9bd87651d97b8e617541d6a3e3274bfa877edd3`; upgrades require review and lock regeneration. No central-repository PAT is used.
