...
import { MarkdownView } from '@/components/akademia/MarkdownView'
import { AdminReviewActions } from '@/components/akademia/AdminReviewActions'
import {
    getCourseDetail,
    getCourseLessons,
...
export default async function AdminCourseReviewPage({ params }: PageProps) {
    ...
    return (
        <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
            <div>
                <Link href="/admin/akademia" className="text-sm text-muted-foreground hover:text-primary inline-flex items-center gap-1 mb-2">
                    ← Kolejka moderacji
                </Link>
